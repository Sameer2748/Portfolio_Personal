...
export const PinContainer = ({
  ...
  const [isMounted, setIsMounted] = useState(false); // Add mounted state to prevent hydration issues
  ...
  if (!isMounted) {
    return null; // Return null until the component has mounted to avoid SSR issues
  }
